...
public class NewsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView ivBack = (ImageView) findViewById(R.id.iv_back);  //返回的图像
        WebView webView = (WebView) findViewById(R.id.wv_news_detail);
        ivShareSdk = (ImageView) findViewById(R.id.iv_share_sdk);   //分享的图像
        ...
        webView.loadUrl(url);   //webView加载html页面
    }
